...
// Limpa os campos e coloca o foco no campo de nome.
    ...
    private void initComponents() {
        ...
        S_Senha = new javax.swing.JPasswordField();
        ...
        S_Senha.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                S_SenhaActionPerformed(evt);
            }
        });
                ...
                .addGroup(TelaLoginLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(TelaLoginLayout.createSequentialGroup()
                        ...
                        .addGroup(TelaLoginLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtcargo, javax.swing.GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE)
                            .addComponent(S_Senha))))
    ...
    private void E_EntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_E_EntrarActionPerformed
        ...
        String senha = S_Senha.getText().trim();
        ...
        if (usuario.equals("admin") && senha.equals("123")) {
            ...
            new EscolhaOpcoes().setVisible(true);
            this.dispose();
        } else {
    ...
    private void S_SenhaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_SenhaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_S_SenhaActionPerformed
    ...
    private javax.swing.JPasswordField S_Senha;
