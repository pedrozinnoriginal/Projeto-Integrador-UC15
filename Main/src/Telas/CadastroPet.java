...
public class CadastroPet extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tituloPet = new javax.swing.JLabel();
        ...
        pesquisarPet = new javax.swing.JLabel();
        ...
        tituloPet.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        tituloPet.setText("Cadastro Pet");
        ...
        btnPesquisarPet.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        btnPesquisarPet.setText("Pesquisar Pet");
        ...
        pesquisarPet.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        pesquisarPet.setText("Pesquisar Pet");

        txtPesquisarPet.setPreferredSize(new java.awt.Dimension(26, 26));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGap(198, 198, 198)
                            .addComponent(tituloPet))
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGap(27, 27, 27)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addComponent(pesquisarPet)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(txtPesquisarPet, javax.swing.GroupLayout.PREFERRED_SIZE, 337, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(TabelaInformacao, javax.swing.GroupLayout.DEFAULT_SIZE, 511, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(TabelaInformacao, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void EnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnterActionPerformed
        ...
        try {
            Pet pet = new Pet();
            pet.setNomePet(Nome.getText().trim());
            pet.setPeso(peso.getText().trim().replace(",", ".")); // Troca vírgula por ponto
            pet.setRaca(raca.getText().trim());
            pet.setVacina(vacina.getText().trim());
            pet.setVencimento(vencimento.getText().trim());
            pet.setVermifugo(vermifugo.getText().trim());
            pet.setVencimentoVermifugo(vencimentovermifugo.getText().trim());
            pet.setControlePraga(CPraga.getText().trim());
            pet.setObservacao(txtobservacao.getText().trim());

            // Se você não usa mais Tutor ID na tela, defina um padrão ou aceite NULL no banco
            pet.setTutorId(1);
            ...
            dtm.addRow(new Object[]{
                pet.getVacina(), pet.getPeso(), pet.getControlePraga(), pet.getVermifugo()
            });

            JOptionPane.showMessageDialog(this, "Pet " + pet.getNomePet() + " salvo com sucesso!");
            LimparCampos();
    ...
    private void btnPesquisarPetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarPetActionPerformed
        String nomeBusca = txtPesquisarPet.getText().trim();
        ...
        try {
            ...
            Pet pet = dao.buscarPorNome(nomeBusca);

            if (pet != null) {
                // Preenche os campos da tela com o que veio do banco
                Nome.setText(pet.getNomePet());
                peso.setText(pet.getPeso());
                raca.setText(pet.getRaca());
                vacina.setText(pet.getVacina());
                vencimento.setText(pet.getVencimento());
                vermifugo.setText(pet.getVermifugo());
                vencimentovermifugo.setText(pet.getVencimentoVermifugo());
                CPraga.setText(pet.getControlePraga());
    ...
    private javax.swing.JLabel pesquisarPet;
    private javax.swing.JTextField raca;
    private javax.swing.JLabel tituloPet;
